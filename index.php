			...
			<div class="row" id="login-overview">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<form id="login-form" role="form" action="../services/users/check-user.php" method="post">
						...
						<div class="form-group">
							<input type="text" name="userid" id="userid" class="form-control input-lg" placeholder="请输入学号">
						</div>
			...
			<div class="row" id="register-overview">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<form id="register-form" role="form" action="../services/users/check-user.php" method="post">
						...
						<div class="form-group">
							<input type="text" name="userid-register" id="userid-register" class="form-control input-lg" placeholder="请输入学号">
						</div>
						
						<div class="form-group">
							<input type="text" name="username-register" id="username-register" class="form-control input-lg" placeholder="请输入姓名">
						</div>
